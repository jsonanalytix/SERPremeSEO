...
export default function HealthcareWebDesignPage() {
  return (
    <>
      ...
      <main>
        {/* Hero — pass healthcare content, suppress portfolio link */}
        <HeroSection content={heroContent} portfolioHref="" />
        ...
        {/* Feature Deep-Dives — pass healthcare content */}
        <FeatureSection content={featuresContent} />

        {/* Pricing — pass healthcare content */}
        <PricingCards content={pricingContent} />
      ...
      {/* Structured Data — Healthcare Web Design */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Premium web design services for healthcare practices. HIPAA-conscious infrastructure, conversion-focused design, and SEO-ready structure built to generate patient inquiries.",
            provider: {
              "@type": "Organization",
              name: "SERPreme SEO",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: "Healthcare Web Design",
                item: "https://serpremeseo.com/services/healthcare-web-design",
              },
            ],
          }),
        }}
